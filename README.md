...
Uses [Leaflet](https://leafletjs.com/) to interactively display maps. The container image is forked from [openfirmware/docker-nginx-leaflet](https://github.com/openfirmware/docker-nginx-leaflet) and built from [cndreiter/docker-nginx-leaflet](https://github.com/cndreiter/docker-nginx-leaflet). The resulting image is available at [docker pull ghcr.io/cndreiter/nginx-leaflet:latest](ghcr.io/cndreiter/nginx-leaflet:latest).
